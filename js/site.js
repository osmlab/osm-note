...
function save(ll, comment) {
    ...
    function success(resp) {
        console.log(resp);
        var j = JSON.parse(resp.responseText || resp);
        $('#note-comment').val('');
    }
}
...
},{"moment":4,"reqwest":5}],3:[function(require,module,exports){
...
},{"ohauth":6,"store":7}],4:[function(require,module,exports){
(function(){// moment.js
// version : 2.0.0
// author : Tim Wood
// license : MIT
...
},{"jshashes":8,"xtend":9}],8:[function(require,module,exports){
(function(global){/**
